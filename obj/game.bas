10color1,11,13:screen1,1,0:width32:definta-z:keyoff:ts=&h3800:l=1:es=192:ey=190:sp=0:s0=0:s1=1:s2=2:s3=3:v=5:r=2:f=0
...
60ify>160thenplay"l10o4gc":fori=0to100:color,,8:f=0:ev=1:color,,13:next:goto30elseifx<ex*8+8andx+8>ex*8andy<ey*8+8and8+y>ey*8thenp=p+1:r=r-1:play"l10o8gc":ea=0:locate1,21:print"Points:"p"catch:"r"level:"f
70ey=ey+ev:ifey>(y/8)+2thenv=v-1:ex=rnd(1)*(30-2)+2:ey=6:es=es+1:ev=1:ec=0:ea=1:putsprite1,(ex*8,2*8),13,4:ifes>215thenes=192
80putsprite0,(x,y),9,sp:locateex,ey-1:printchr$(32):ifea=1thenlocateex,ey:printchr$(es):t=base(5)+((y/8)+2)*32+(x/8)+1:ifvpeek(t)<>215theny=y+8
